        ...
        <div className="flex flex-wrap gap-4 mb-10">
          {stats.map((stat) => {
            return (
              <div
                key={stat.label}
                 className="relative flex-1 min-w-[210px] bg-white rounded-[24px] p-5 shadow-[0_4px_15px_rgba(0,0,0,0.05)] border-2 border-transparent transition-all duration-300 overflow-hidden"
              >
